...
def test_crop_to_bbox_changes_the_loaded_image(tmp_path):
    ...
    # cropped to the (mostly white) animal box => much brighter than the full, mostly-black
...
def test_letterbox_pads_and_preserves_aspect():
    ...
    # a 4:3 frame with a bright band down the far-left edge
...
def test_megadetector_box_maps_back_to_image_coordinates():
    ...
    # src.megadetector imports yolov5 lazily inside best_animal_box, so importing the module
